  ...
  Future<void> _pickImage(BuildContext context, bool isFront) async {
    ...
    try {
      ...
      if (image != null) {
        ...
        if (isFront) {
          controller.updateData(controller.kycData.copyWith(idFrontImage: file));
        } else {
      ...
      child: Column(
        ...
        children: [
          ...
          DocumentScanCard(
            ...
            hintText: kycData.idFrontImage != null ? 'Đã chụp mặt trước' : 'Nhấn để chụp mặt trước',
            infoText: 'Đảm bảo hình ảnh rõ nét, không bị nhòe, không bị lóa sáng và đủ 4 góc của thẻ.',
          ...
          DocumentScanCard(
            ...
            hintText: kycData.idBackImage != null ? 'Đã chụp mặt sau' : 'Nhấn để chụp mặt sau',
            infoText: 'Hình ảnh cần nhìn rõ các thông tin và mã vạch phía sau tài liệu.',
